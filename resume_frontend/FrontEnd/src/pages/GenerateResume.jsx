...
function GenerateResume() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
                        const resumeData = await ResumeService.generateResume(JSON.stringify(formData));
                ...
                <div className={cardClass}>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button type="button" onClick={() => { setUserDescription(''); setError(''); setSuccess(''); }} className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors duration-200">
                                Clear
                            </button>
                        </div>
                    </form>
